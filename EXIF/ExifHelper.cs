...
public class ExifHelper : IDisposable
{
    ...
    public readonly struct GPSRational(byte[] value)
    {
    ...
    public struct Rational
    {
        ...
        public readonly string ToString(string Delimiter = "/")
        {
    ...
    public static readonly Hashtable Tags = [];
    ...
    {
        get { return GetPropertyString((int)TagNames.EquipMake); }
    }
    ...
    {
        get { return GetPropertyString((int)TagNames.EquipModel); }
    }
    ...
    {
        get { return GetPropertyString((int)TagNames.SoftwareUsed); }
    }
    ...
    public string Copyright
    {
        ...
        set
        {
            try
            {
                SetPropertyString((int)TagNames.Copyright, value.ToString());
            }
            catch { }
        }
    }
    ...
    public double Aperture
    {
        get
        {
            ...
            {
                return Math.Pow(System.Math.Sqrt(2), GetPropertyRational((int)TagNames.ExifAperture).ToDouble());
            }
            else
            {
                return 0;
    ...
    {
        return System.Convert.ToBoolean(Array.IndexOf(_Image.PropertyIdList, PID) > -1);
    }
    ...
    /// </history>
    public byte[] GetProperty(int PID, byte[] DefaultValue = null)
    {
        if (IsPropertyDefined(PID))
        {
    ...
    {
        byte[] Data = [System.Convert.ToByte(Value & 0xff), System.Convert.ToByte((Value & 0xff00) >> 8)];
    ...
    /// </history>
    private static int GetInt32(byte[] B)
    {
        if (B.Length < 4)
            throw new ArgumentException("Data too short (4 bytes expected)", nameof(B));
    ...
    /// [altair] 05.09.2005 Changed from public shared to private instance method
    /// </history>
    private static short GetInt16(byte[] B)
    {
        if (B.Length < 2)
            throw new ArgumentException("Data too short (2 bytes expected)", nameof(B));
